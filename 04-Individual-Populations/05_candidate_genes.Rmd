...
for(i in 1:nrow(bias_and_all)) {                     
  ...
  if(bias_and_all$density[i] <= 0.004233183){
...
write.table(bias_and_all, 
            "results/2023-08-04-ranked_by_dens-POP-1.txt", 
            quote = FALSE, 
            col.names = TRUE, 
            row.names = FALSE)

write.table(bias_and_all$gene, 
            "results/2023-08-04-POP-1-Genes.txt", 
            quote = FALSE, 
            col.names = FALSE, 
            row.names = FALSE)
...
write.table(candidates_pop4$gene, 
            "results/2023-08-04-POP-1-Candidate_Genes.txt", 
            quote = FALSE, 
            col.names = FALSE, 
            row.names = FALSE)
